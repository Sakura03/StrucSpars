...
def conv3x3(in_planes: int, out_planes: int, stride: int = 1, dilation: int = 1, power: float = 0.5) -> GroupableConv2d:
...
def conv1x1(in_planes: int, out_planes: int, stride: int = 1, power: float = 0.5) -> GroupableConv2d:
    """1x1 convolution"""
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.bn1 = norm_layer(planes)
        self.conv2 = conv3x3(planes, planes, stride, power=power)
        self.bn2 = norm_layer(planes)
